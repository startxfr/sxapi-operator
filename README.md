...
# sxapi operator ![sxapi](https://img.shields.io/badge/latest-v0.0.9-blue.svg)
...
- The `sxapi-catalog` **CatalogSource**, into the `openshift-marketplace` namespace, running the `quay.io/startx/sxapi-operator-catalog:v0.0.9` catalog image
