...
# - use the VERSION as arg of the bundle target (e.g make bundle VERSION=0.0.1)
# - use environment variables to overwrite this value (e.g export VERSION=0.0.1)
VERSION ?= 0.0.9
...
export CHANNELS = "alpha,fast,stable"
...
# startx.fr/sxapi-operator-bundle:$VERSION and startx.fr/sxapi-operator-catalog:$VERSION.
IMAGE_TAG_BASE ?= quay.io/startx/sxapi-operator
